...
const sections = [
  ...
  },
  {
    ...
    paragraphs: [
      'A regisztrációval a Kiemelt Mester előfizetés 90 napos díjmentes próbaidőszaka indul. A próbaidőszak megkezdéséhez érvényes fizetési mód szükséges; az első terhelés a 90 nap letelte után esedékes. Ezt követően a Stripe Billing a regisztrációkor választott havi nettó 4 990 Ft-os vagy éves nettó 54 990 Ft-os díjat automatikusan terheli, és kezeli az elektronikus fizetési bizonylatokat.',
      ...
      'A próbaidőszak alatt az előfizetés bármikor, kötbér nélkül lemondható. Ha az előfizető a 90 nap lejárta előtt lemondja, előfizetési díj nem kerül felszámításra; ellenkező esetben az előfizetés automatikusan fizetős időszakba fordul.',
      'Érvényes magyar közösségi adószám esetén az EU B2B fordított adózás (reverse charge / omvänd skattskyldighet) szabályai alkalmazhatók, 0%-os svéd áfával. A regisztráló felel az adószám és a számlázási adatok helyességéért, valamint a magyarországi áfabevallási kötelezettség teljesítéséért.',
    ],
  },
  {
