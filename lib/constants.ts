...
const CATEGORY_LIST = [
  { key: 'allatorvos', name: 'Állatorvos', icon: PawPrint, description: 'Kisállatok vizsgálata, kezelése és egészségügyi ellátása' },
  { key: 'asztalos', name: 'Asztalos', icon: Hammer, description: 'Egyedi bútorok és fa szerkezetek készítése, javítása' },
  { key: 'autoklima-szerelo', name: 'Autóklíma-szerelő', icon: Fan, description: 'Gépjármű-klímák töltése, javítása és karbantartása' },
  { key: 'autoszerelo', name: 'Autószerelő', icon: Wrench, description: 'Gépjárművek javítása és karbantartása' },
  { key: 'gumiszerviz', name: 'Gumiszerviz', icon: LifeBuoy, description: 'Gumiabroncs-szerelés, javítás és kerékcsere' },
  { key: 'tetoszerkezet-badogozas', name: 'Tetőszerkezet & Bádogozás', icon: Home, description: 'Tetőszerkezet, tetőfedés, bádogozás és ereszcsatorna' },
  { key: 'bojler-szerelo', name: 'Bojler szerelő', icon: Thermometer, description: 'Villany- és gázbojlerek javítása' },
  { key: 'cserepkalyha-epito', name: 'Cserépkályha építő', icon: Flame, description: 'Cserépkályhák építése és felújítása' },
  { key: 'darazsirto-kartevo-irto', name: 'Darázsirtó (Kártevőirtó)', icon: BugOff, description: 'Darazsak és más kártevők szakszerű irtása' },
  { key: 'dugulaselharitas', name: 'Duguláselhárítás', icon: Pipette, description: 'Lefolyók és csatornák sürgős tisztítása' },
  { key: 'favago-alpintechnika', name: 'Favágó (Alpintechnika)', icon: Axe, description: 'Veszélyes fák alpintechnikai kivágása' },
  { key: 'garazskapu-szerelo', name: 'Garázskapu szerelő', icon: Warehouse, description: 'Garázskapuk és automatikák szerelése' },
  { key: 'gepesz-gepi-foldmunkas', name: 'Gépész / Gépi földmunkás', icon: Tractor, description: 'Gépi földmunka és tereprendezés' },
  { key: 'gipszkartonszerelo', name: 'Gipszkartonszerelő', icon: Layout, description: 'Falak és álmennyezetek kivitelezése' },
  ...
  { key: 'hideg-melegburkolas', name: 'Hidegburkolás / Melegburkolás', icon: Layers, description: 'Csempék, járólapok, parketták és padlók kivitelezése' },
  { key: 'ho-vizszigeteles', name: 'Hő- és vízszigetelés', icon: ThermometerSun, description: 'Épületek szakszerű hő- és vízszigetelése' },
  { key: 'kaputelefon-szerelo', name: 'Kaputelefon szerelő', icon: PhoneCall, description: 'Kaputelefonok és beléptetők javítása' },
  { key: 'karpitos', name: 'Kárpitos', icon: Sofa, description: 'Bútorok javítása és újrakárpitozása' },
  { key: 'karpittisztito', name: 'Kárpittisztító', icon: Sparkles, description: 'Kárpitok és szőnyegek mélytisztítása' },
  { key: 'kemenysepro', name: 'Kéményseprő', icon: Wind, description: 'Kémények ellenőrzése és tisztítása' },
  ...
  { key: 'kutfuro', name: 'Kútfúró', icon: ArrowDownToLine, description: 'Kutak fúrása és kiépítése' },
  { key: 'kutyakozmetikus', name: 'Kutyakozmetikus', icon: Scissors, description: 'Kutyák szakszerű kozmetikája és ápolása' },
  { key: 'lakatos', name: 'Lakatos', icon: Anvil, description: 'Fémszerkezetek készítése, szerelése és javítása' },
  { key: 'lomtalanito', name: 'Lomtalanító', icon: Trash2, description: 'Lomok elszállítása és területek kiürítése' },
  { key: 'medenceepito', name: 'Medenceépítő', icon: Waves, description: 'Medencék építése és gépészete' },
  { key: 'napelem-szerelo', name: 'Napelem szerelő', icon: SunMedium, description: 'Napelemes rendszerek telepítése' },
  { key: 'nyilaszaro-beepito', name: 'Nyílászáró beépítő', icon: DoorOpen, description: 'Ablakok és ajtók beépítése, cseréje és beállítása' },
  { key: 'ontozorendszer-telepito', name: 'Öntözőrendszer telepítő', icon: CloudRain, description: 'Automata öntözőrendszerek telepítése' },
  ...
  { key: 'kamerarendszer-riasztotelepites', name: 'Kamerarendszer & Riasztótelepítés', icon: Cctv, description: 'Kamerák, riasztók és biztonsági rendszerek telepítése' },
  { key: 'szamitogep-szerviz', name: 'Számítógép szerviz', icon: Laptop, description: 'Számítógépek javítása és karbantartása' },
  { key: 'szobafesto', name: 'Szobafestő', icon: PaintRoller, description: 'Beltéri és kültéri festési munkák' },
  { key: 'takaritoceg', name: 'Takarítócég', icon: SprayCan, description: 'Otthonok és üzleti terek takarítása' },
  { key: 'terkovezo', name: 'Térkövező', icon: LayoutGrid, description: 'Udvarok, járdák és kocsibeállók térkövezése' },
  { key: 'uveges', name: 'Üveges', icon: Maximize, description: 'Üvegezés, tükör és ablakjavítás' },
  { key: 'villanyszereles', name: 'Villanyszerelés', icon: Zap, description: 'Elektromos hálózatok kiépítése, javítása és felülvizsgálata' },
  { key: 'viz-gaz-futesszereles', name: 'Víz-, gáz-, fűtésszerelés', icon: Droplet, description: 'Víz-, gáz- és fűtési rendszerek szerelése és javítása' },
  { key: 'zarszerelo', name: 'Zárszerelő', icon: Key, description: 'Zárnyitás, zárcsere és biztonsági zárak' },
] as const
